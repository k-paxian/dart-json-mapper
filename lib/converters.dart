...
abstract class ICustomConverter {
  dynamic toJSON(Object object, JsonProperty jsonProperty, [InstanceMirror objectMirror]);
  Object fromJSON(dynamic jsonValue, JsonProperty jsonProperty, [VariableMirror variableMirror]);
}
...
class DateConverter implements ICustomConverter {
  ...
  @override
  dynamic toJSON(Object object, JsonProperty jsonProperty, [InstanceMirror objectMirror]) {
    DateTime dt = (object as DateTime).toUtc();
...
class EnumConverter implements ICustomConverter {
  ...
  Object fromJSON(dynamic jsonValue, JsonProperty jsonProperty, [VariableMirror variableMirror]) {
    ...
    return dm.reflectClass(cm.reflectedType).getField(#values).reflectee[jsonValue];
  }
